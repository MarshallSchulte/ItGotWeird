  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved blog as @blog" do
        ...
        post :create, {:blog => { "userId" => "invalid value" }}, valid_session
        assigns(:blog).should be_a_new(Blog)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested blog" do
        ...
        Blog.any_instance.should_receive(:update).with({ "userId" => "1" })
        put :update, {:id => blog.to_param, :blog => { "userId" => "1" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the blog as @blog" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Blog.any_instance.stub(:save).and_return(false)
        put :update, {:id => blog.to_param, :blog => { "userId" => "invalid value" }}, valid_session
        assigns(:blog).should eq(blog)
      end
